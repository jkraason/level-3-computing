...
r = 0.03
d = 0.02
N = 400                    # larger system → smoother Psi6
densities = np.array([0.67,0.69,0.71,0.73])
...
for idx, density in enumerate(densities):
    psi_file = f"N=400HS2Dpsi6_eta_{density:.2f}.npz"
...
plt.axhline(1, color='black', linestyle='--', label='HCP lattice')
...
plt.savefig('N=400HS2Dpsi6.png', dpi=300)
plt.show()
